SELECT 
    ...
    "raf1"."UDF_DATE1" AS "From", 
    "raf1"."UDF_DATE2" AS "To" ,
    "Request_UDF_PickListValues_UDF_PICK7"."VALUE" AS "Planned(Y/N)"
...
LEFT JOIN "Request_Additional_Fields_1" "raf1" ON "wo"."WORKORDERID"="raf1"."WORKORDERID"
...
LEFT JOIN "Request_Additional_Fields_2" "raf2" ON "wo"."WORKORDERID"="raf2"."WORKORDERID" 
LEFT JOIN "Request_UDF_PickListValues" "Request_UDF_PickListValues_UDF_PICK7" ON "raf2"."UDF_PICK7"="Request_UDF_PickListValues_UDF_PICK7"."PickListID" 
...
WHERE 
	...
	(
        ...
        (
            (
                "wo"."CREATEDTIME" >= 1635689600000 AND  -- Start of 2024 (2024-01-01 00:00:00)
                "wo"."CREATEDTIME" <= 1930297599000 AND  -- End of 2027 (2027-12-31 23:59:59)
